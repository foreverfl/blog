export default function PrivacyPolicyEn() {
  return (
    <div className="p-6 bg-white dark:bg-[#090909] text-gray-900 dark:text-gray-100">
      <h1 className="text-3xl font-bold b-4">Privacy Policy</h1>
      ...
      <ul className="list-none list-inside space-y-2">
        ...
        <li>
          ...
          this Agreement) refers to mogumogu.
        </li>
        <li>
        ...
        <li>
          <strong>Website</strong> refers to mogumogu, accessible from{" "}
          <a
      ...
      <ul className="list-none list-inside space-y-2">
        <li>By email: forevermfl@gmail.com</li>
      </ul>
    </div>
  );
}
